...
'#Region "#CreateComment"
            ...
            Dim commentName As String = System.[String].Empty
            For Each c As Char In commentAuthor
                If Char.IsLetter(c) AndAlso Char.IsUpper(c) Then commentName += c
            Next
...
'#Region "#DeleteComment"
            Call RichEditAPISample.CodeExamples.CommentsActions.CommentHelper.CreateComment(document)
